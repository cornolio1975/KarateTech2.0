...
const SEED_CATEGORIES: Category[] = [
  { id: 'cat-1', name: '5-7 YEARS MALE KATA', gender: 'Male', min_age: 5, max_age: 7, min_weight: 0, max_weight: 99, format: 'knockout', capacity: 32, status: 'Open' },
  { id: 'cat-2', name: '5-7 YEARS FEMALE KATA', gender: 'Female', min_age: 5, max_age: 7, min_weight: 0, max_weight: 99, format: 'knockout', capacity: 32, status: 'Open' },
  { id: 'cat-3', name: '8-10 YEARS MALE KATA', gender: 'Male', min_age: 8, max_age: 10, min_weight: 0, max_weight: 99, format: 'knockout', capacity: 32, status: 'Open' },
  { id: 'cat-4', name: '8-10 YEARS FEMALE KATA', gender: 'Female', min_age: 8, max_age: 10, min_weight: 0, max_weight: 99, format: 'knockout', capacity: 32, status: 'Open' },
  { id: 'cat-5', name: '11-13 YEARS MALE KATA', gender: 'Male', min_age: 11, max_age: 13, min_weight: 0, max_weight: 99, format: 'knockout', capacity: 32, status: 'Open' },
  { id: 'cat-6', name: '11-13 YEARS FEMALE KATA', gender: 'Female', min_age: 11, max_age: 13, min_weight: 0, max_weight: 99, format: 'knockout', capacity: 32, status: 'Open' },
  { id: 'cat-7', name: '14-15 YEARS MALE KATA', gender: 'Male', min_age: 14, max_age: 15, min_weight: 0, max_weight: 99, format: 'knockout', capacity: 32, status: 'Open' },
  { id: 'cat-8', name: '14-15 YEARS FEMALE KATA', gender: 'Female', min_age: 14, max_age: 15, min_weight: 0, max_weight: 99, format: 'knockout', capacity: 32, status: 'Open' },
  { id: 'cat-9', name: '16-17 YEARS MALE KATA', gender: 'Male', min_age: 16, max_age: 17, min_weight: 0, max_weight: 99, format: 'knockout', capacity: 32, status: 'Open' },
  { id: 'cat-10', name: '16-17 YEARS FEMALE KATA', gender: 'Female', min_age: 16, max_age: 17, min_weight: 0, max_weight: 99, format: 'knockout', capacity: 32, status: 'Open' },
  { id: 'cat-11', name: '18-21 YEARS MALE KATA', gender: 'Male', min_age: 18, max_age: 21, min_weight: 0, max_weight: 99, format: 'knockout', capacity: 32, status: 'Open' },
  { id: 'cat-12', name: '18-21 YEARS FEMALE KATA', gender: 'Female', min_age: 18, max_age: 21, min_weight: 0, max_weight: 99, format: 'knockout', capacity: 32, status: 'Open' },
  { id: 'cat-13', name: '5 YEARS MALE KUMITE', gender: 'Male', min_age: 5, max_age: 5, min_weight: 0, max_weight: 99, format: 'knockout', capacity: 32, status: 'Open' },
  { id: 'cat-14', name: '5 YEARS FEMALE KUMITE', gender: 'Female', min_age: 5, max_age: 5, min_weight: 0, max_weight: 99, format: 'knockout', capacity: 32, status: 'Open' },
  { id: 'cat-15', name: '6-7 YEARS MALE KUMITE (BELOW 24KG)', gender: 'Male', min_age: 6, max_age: 7, min_weight: 0, max_weight: 24.5, format: 'knockout', capacity: 32, status: 'Open' },
  { id: 'cat-16', name: '6-7 YEARS FEMALE KUMITE (BELOW 20KG)', gender: 'Female', min_age: 6, max_age: 7, min_weight: 0, max_weight: 20.5, format: 'knockout', capacity: 32, status: 'Open' },
  { id: 'cat-17', name: '6-7 YEARS MALE KUMITE (ABOVE 24KG)', gender: 'Male', min_age: 6, max_age: 7, min_weight: 24.6, max_weight: 99, format: 'knockout', capacity: 32, status: 'Open' },
  { id: 'cat-18', name: '6-7 YEARS FEMALE KUMITE (ABOVE 20KG)', gender: 'Female', min_age: 6, max_age: 7, min_weight: 20.6, max_weight: 99, format: 'knockout', capacity: 32, status: 'Open' },
  { id: 'cat-19', name: '8-9 YEARS MALE KUMITE (BELOW 25KG)', gender: 'Male', min_age: 8, max_age: 9, min_weight: 0, max_weight: 25.5, format: 'knockout', capacity: 32, status: 'Open' },
  { id: 'cat-20', name: '8-9 YEARS FEMALE KUMITE (BELOW 25KG)', gender: 'Female', min_age: 8, max_age: 9, min_weight: 0, max_weight: 25.5, format: 'knockout', capacity: 32, status: 'Open' },
  { id: 'cat-21', name: '8-9 YEARS MALE KUMITE (ABOVE 25KG)', gender: 'Male', min_age: 8, max_age: 9, min_weight: 25.6, max_weight: 99, format: 'knockout', capacity: 32, status: 'Open' },
  { id: 'cat-22', name: '8-9 YEARS FEMALE KUMITE (ABOVE 25KG)', gender: 'Female', min_age: 8, max_age: 9, min_weight: 25.6, max_weight: 99, format: 'knockout', capacity: 32, status: 'Open' },
  { id: 'cat-23', name: '10-11 YEARS MALE KUMITE (BELOW 30KG)', gender: 'Male', min_age: 10, max_age: 11, min_weight: 0, max_weight: 30.5, format: 'knockout', capacity: 32, status: 'Open' },
  { id: 'cat-24', name: '10-11 YEARS FEMALE KUMITE (BELOW 30KG)', gender: 'Female', min_age: 10, max_age: 11, min_weight: 0, max_weight: 30.5, format: 'knockout', capacity: 32, status: 'Open' },
  { id: 'cat-25', name: '10-11 YEARS MALE KUMITE (BELOW 40KG)', gender: 'Male', min_age: 10, max_age: 11, min_weight: 30.6, max_weight: 40.5, format: 'knockout', capacity: 32, status: 'Open' },
  { id: 'cat-26', name: '10-11 YEARS FEMALE KUMITE (BELOW 40KG)', gender: 'Female', min_age: 10, max_age: 11, min_weight: 30.6, max_weight: 40.5, format: 'knockout', capacity: 32, status: 'Open' },
  { id: 'cat-27', name: '10-11 YEARS MALE KUMITE (ABOVE 40KG)', gender: 'Male', min_age: 10, max_age: 11, min_weight: 40.6, max_weight: 99, format: 'knockout', capacity: 32, status: 'Open' },
  { id: 'cat-28', name: '10-11 YEARS FEMALE KUMITE (ABOVE 40KG)', gender: 'Female', min_age: 10, max_age: 11, min_weight: 40.6, max_weight: 99, format: 'knockout', capacity: 32, status: 'Open' },
  { id: 'cat-29', name: '12-13 YEARS MALE KUMITE (BELOW 40KG)', gender: 'Male', min_age: 12, max_age: 13, min_weight: 0, max_weight: 40.5, format: 'knockout', capacity: 32, status: 'Open' },
  { id: 'cat-30', name: '12-13 YEARS FEMALE KUMITE (BELOW 42KG)', gender: 'Female', min_age: 12, max_age: 13, min_weight: 0, max_weight: 42.5, format: 'knockout', capacity: 32, status: 'Open' },
  { id: 'cat-31', name: '12-13 YEARS MALE KUMITE (BELOW 45KG)', gender: 'Male', min_age: 12, max_age: 13, min_weight: 40.6, max_weight: 45.5, format: 'knockout', capacity: 32, status: 'Open' },
  { id: 'cat-32', name: '12-13 YEARS FEMALE KUMITE (BELOW 47KG)', gender: 'Female', min_age: 12, max_age: 13, min_weight: 42.6, max_weight: 47.5, format: 'knockout', capacity: 32, status: 'Open' },
  { id: 'cat-33', name: '12-13 YEARS MALE KUMITE (ABOVE 45KG)', gender: 'Male', min_age: 12, max_age: 13, min_weight: 45.6, max_weight: 999, format: 'knockout', capacity: 32, status: 'Open' },
  { id: 'cat-34', name: '12-13 YEARS FEMALE KUMITE (ABOVE 47KG)', gender: 'Female', min_age: 12, max_age: 13, min_weight: 47.6, max_weight: 999, format: 'knockout', capacity: 32, status: 'Open' },
  { id: 'cat-35', name: '14-15 YEARS MALE KUMITE (BELOW 52KG)', gender: 'Male', min_age: 14, max_age: 15, min_weight: 0, max_weight: 52.5, format: 'knockout', capacity: 32, status: 'Open' },
  { id: 'cat-36', name: '14-15 YEARS FEMALE KUMITE (BELOW 47KG)', gender: 'Female', min_age: 14, max_age: 15, min_weight: 0, max_weight: 47.5, format: 'knockout', capacity: 32, status: 'Open' },
  { id: 'cat-37', name: '14-15 YEARS MALE KUMITE (BELOW 57KG)', gender: 'Male', min_age: 14, max_age: 15, min_weight: 52.6, max_weight: 57.5, format: 'knockout', capacity: 32, status: 'Open' },
  { id: 'cat-38', name: '14-15 YEARS FEMALE KUMITE (BELOW 54KG)', gender: 'Female', min_age: 14, max_age: 15, min_weight: 47.6, max_weight: 54.5, format: 'knockout', capacity: 32, status: 'Open' },
  { id: 'cat-39', name: '14-15 YEARS MALE KUMITE (ABOVE 57KG)', gender: 'Male', min_age: 14, max_age: 15, min_weight: 57.6, max_weight: 999, format: 'knockout', capacity: 32, status: 'Open' },
  { id: 'cat-40', name: '14-15 YEARS FEMALE KUMITE (ABOVE 54KG)', gender: 'Female', min_age: 14, max_age: 15, min_weight: 54.6, max_weight: 999, format: 'knockout', capacity: 32, status: 'Open' },
  { id: 'cat-41', name: '16-17 YEARS MALE KUMITE (BELOW 55KG)', gender: 'Male', min_age: 16, max_age: 17, min_weight: 0, max_weight: 55.5, format: 'knockout', capacity: 32, status: 'Open' },
  { id: 'cat-42', name: '16-17 YEARS FEMALE KUMITE (BELOW 48KG)', gender: 'Female', min_age: 16, max_age: 17, min_weight: 0, max_weight: 48.5, format: 'knockout', capacity: 32, status: 'Open' },
  { id: 'cat-43', name: '16-17 YEARS MALE KUMITE (BELOW 61KG)', gender: 'Male', min_age: 16, max_age: 17, min_weight: 55.6, max_weight: 61.5, format: 'knockout', capacity: 32, status: 'Open' },
  { id: 'cat-44', name: '16-17 YEARS FEMALE KUMITE (BELOW 53KG)', gender: 'Female', min_age: 16, max_age: 17, min_weight: 48.6, max_weight: 53.5, format: 'knockout', capacity: 32, status: 'Open' },
  { id: 'cat-45', name: '16-17 YEARS MALE KUMITE (BELOW 68KG)', gender: 'Male', min_age: 16, max_age: 17, min_weight: 61.6, max_weight: 68.5, format: 'knockout', capacity: 32, status: 'Open' },
  { id: 'cat-46', name: '16-17 YEARS FEMALE KUMITE (BELOW 59KG)', gender: 'Female', min_age: 16, max_age: 17, min_weight: 53.6, max_weight: 59.5, format: 'knockout', capacity: 32, status: 'Open' },
  { id: 'cat-47', name: '16-17 YEARS MALE KUMITE (ABOVE 68KG)', gender: 'Male', min_age: 16, max_age: 17, min_weight: 68.6, max_weight: 999, format: 'knockout', capacity: 32, status: 'Open' },
  { id: 'cat-48', name: '16-17 YEARS FEMALE KUMITE (ABOVE 59KG)', gender: 'Female', min_age: 16, max_age: 17, min_weight: 59.6, max_weight: 999, format: 'knockout', capacity: 32, status: 'Open' },
  { id: 'cat-49', name: '18-21 YEARS MALE KUMITE (BELOW 57KG)', gender: 'Male', min_age: 18, max_age: 21, min_weight: 0, max_weight: 57.5, format: 'knockout', capacity: 32, status: 'Open' },
  { id: 'cat-50', name: '18-21 YEARS FEMALE KUMITE (BELOW 52KG)', gender: 'Female', min_age: 18, max_age: 21, min_weight: 0, max_weight: 52.5, format: 'knockout', capacity: 32, status: 'Open' },
  { id: 'cat-51', name: '18-21 YEARS MALE KUMITE (BELOW 62KG)', gender: 'Male', min_age: 18, max_age: 21, min_weight: 57.6, max_weight: 62.5, format: 'knockout', capacity: 32, status: 'Open' },
  { id: 'cat-52', name: '18-21 YEARS FEMALE KUMITE (BELOW 57KG)', gender: 'Female', min_age: 18, max_age: 21, min_weight: 52.6, max_weight: 57.5, format: 'knockout', capacity: 32, status: 'Open' },
  { id: 'cat-53', name: '18-21 YEARS MALE KUMITE (BELOW 70KG)', gender: 'Male', min_age: 18, max_age: 21, min_weight: 62.6, max_weight: 70.5, format: 'knockout', capacity: 32, status: 'Open' },
  { id: 'cat-54', name: '18-21 YEARS FEMALE KUMITE (BELOW 62KG)', gender: 'Female', min_age: 18, max_age: 21, min_weight: 57.6, max_weight: 62.5, format: 'knockout', capacity: 32, status: 'Open' },
  { id: 'cat-55', name: '18-21 YEARS MALE KUMITE (ABOVE 70KG)', gender: 'Male', min_age: 18, max_age: 21, min_weight: 70.6, max_weight: 999, format: 'knockout', capacity: 32, status: 'Open' },
  { id: 'cat-56', name: '18-21 YEARS FEMALE KUMITE (ABOVE 62KG)', gender: 'Female', min_age: 18, max_age: 21, min_weight: 62.6, max_weight: 999, format: 'knockout', capacity: 32, status: 'Open' },
  { id: 'cat-57', name: '22-40 YEARS MALE KUMITE (OPEN)', gender: 'Male', min_age: 22, max_age: 40, min_weight: 40, max_weight: 999, format: 'knockout', capacity: 32, status: 'Open' }
];
...
export const mockStore = {
  ...
  bouts: {
    ...
    _propagateWalkovers: (categoryId: string, list: Bout[]): void => {
      const maxRound = Math.max(...list.filter(b => b.category_id === categoryId && b.round_no !== 99 && b.round_no !== 98).map(b => b.round_no), 1);
      let changes = true;
      while (changes) {
        changes = false;
        for (let r = 1; r < maxRound; r++) {
          const currentRoundBouts = list.filter(b => b.category_id === categoryId && b.round_no === r);
          const nextRoundBouts = list.filter(b => b.category_id === categoryId && b.round_no === r + 1);
    ...
    updateBoutResult: (boutId: string, winnerId: string, scoreA: number, scoreB: number): Bout => {
      ...
      if (bout.round_no === 98) {
        ...
        mockStore.bouts._propagateWalkovers(bout.category_id, list);
      }
    ...
    updateBoutState: (id: string, updates: Partial<Bout>): Bout => {
      ...
      mockStore.bouts._propagateWalkovers(updated.category_id, list);
    ...
    reassignParticipant: (boutId: string, position: 'AKA' | 'AO', newParticipantId: string, categoryId: string, tournamentId?: string): Bout => {
      ...
      bouts[boutIdx] = bout;
      mockStore.bouts._propagateWalkovers(categoryId, bouts);
